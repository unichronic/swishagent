...
def build_case_state(
    *,
    ...
    return {
        ...
        "semantic_analysis": {
            "customer_meaning": assessment.get("customer_meaning") or resolution_debug.get("customer_meaning") or "",
            "reasoning_brief": assessment.get("reasoning_brief") or resolution_debug.get("reasoning_brief") or "",
            "uncertainty_reason": assessment.get("uncertainty_reason") or resolution_debug.get("uncertainty_reason") or "",
            "policy_risk_flags": assessment.get("policy_risk_flags") or resolution_debug.get("policy_risk_flags") or [],
            "semantic_risk": bool(assessment.get("semantic_risk") or resolution_debug.get("semantic_risk")),
            "semantic_confidence": assessment.get("semantic_confidence") or resolution_debug.get("semantic_confidence"),
        },
